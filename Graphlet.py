...
class Graphlet:
    ...
    def print_triangles(self):
        ...
        print("number of total open triangle: %d" % len(self.total_open_triangle))
...
if __name__ == "__main__":
    ...
    # filenames = get_file_name('E:\\chen\\图卷积——小图')
    # for filename in filenames:
    #     f = filename.split('\\')
    #     f = f[3].split('.')[0]
    #     G = nx.read_edgelist('E:\\chen\\图卷积——小图\\' + f + '.txt')
    ...
    #
    #     print('g1', len(graphlet.total_close_triangle), file=file)
    #     print('g2', len(graphlet.total_open_triangle), file=file)
    #
    #     # graphlet.print_4_nodes()
    #
    #     print('g3', len(graphlet.total_four_path), file=file)
    #     print('g4', len(graphlet.total_three_star), file=file)
    #     print('g5', len(graphlet.total_four_cycle), file=file)
    #     print('g6', len(graphlet.total_four_tailed_triangle), file=file)
    #     print('g7', len(graphlet.total_four_chordal_cycle), file=file)
    #     print('g8', len(graphlet.total_four_clique), file=file)
    #
    #     print("\n")
    #     k = 8
    #
    #     for i in graphlet.total_five_graphlet:
    #         print('g' + str(k+1), len(i), file=file)
    #         k = k + 1
    #
    #     file.close()
    #

    filenames = get_file_name('/home/lmx/chen/graphlets/noisy')
    path = '/home/lmx/chen/graphlets/new_noisy_label/'
    for filename in filenames:
        t1 = time.time()
        start = int(round(t1 * 1000))

        G = nx.Graph()
        G = nx.read_edgelist(filename)
        f = filename.split('/')[-1].split('.')[0]
        file = open(path + f + '_label.txt', 'w')
        graphlet = Graphlet(G)

        t2 = time.time()
        end = int(round(t2 * 1000))
        # graphlet.print_4_nodes()
        print('g1', len(graphlet.total_close_triangle), file=file)
        print('g2', len(graphlet.total_open_triangle), file=file)
        ...
        print("ok1 using time : ", end - start)
        k = 8
    ...
    # filenames = get_file_name('/home/lmx/chen/graphlets/noisy')
    # f = open('graphletsedgecount.txt','w')
    ...
    #     filename1 = filename
    #     # filename2 = '/home/lmx/chen/graphlets/testset/0bison0.txt'
    #     filename2 = filename1
    #     G1 = nx.read_edgelist(filename1)
    #     G2 = nx.read_edgelist(filename2)

    #     print('size of G1 : ' + str(len(G1.nodes)))
    #     # print('size of G2 : ' + str(len(G2.nodes)))

    #     graphlet1 = Graphlet(G1)
    #     graphlet2 = Graphlet(G2)

    #     graphlets1 = []
    #     graphlets1.append(len(graphlet1.total_close_triangle)+1)
    #     graphlets1.append(len(graphlet1.total_open_triangle)+1)
    #     graphlets1.append(len(graphlet1.total_four_path)+1)
    #     graphlets1.append(len(graphlet1.total_four_cycle)+1)
    #     graphlets1.append(len(graphlet1.total_four_cycle)+1)
    #     graphlets1.append(len(graphlet1.total_four_tailed_triangle)+1)
    #     graphlets1.append(len(graphlet1.total_four_chordal_cycle)+1)
    #     graphlets1.append(len(graphlet1.total_four_clique)+1)
    #     for i in graphlet1.total_five_graphlet:
    #             graphlets1.append(len(i)+1)
    #     # print(graphlets1)
    #     graphlets2 = []
    #     graphlets2.append(len(graphlet2.total_close_triangle)+1)
    #     graphlets2.append(len(graphlet2.total_open_triangle)+1)
    #     graphlets2.append(len(graphlet2.total_four_path)+1)
    #     graphlets2.append(len(graphlet2.total_four_cycle)+1)
    #     graphlets2.append(len(graphlet2.total_four_cycle)+1)
    #     graphlets2.append(len(graphlet2.total_four_tailed_triangle)+1)
    #     graphlets2.append(len(graphlet2.total_four_chordal_cycle)+1)
    #     graphlets2.append(len(graphlet2.total_four_clique)+1)
    #     for i in graphlet2.total_five_graphlet:
    #             graphlets2.append(len(i)+1)
    #     # print(graphlets2)

    #     frequency1 = np.array(graphlets1)
    #     frequency1 = frequency1 / sum(frequency1)
    #     frequency1 = np.log10(frequency1)
    #     frequency1 = list(frequency1)

    #     frequency2 = np.array(graphlets2)
    #     frequency2 = frequency2 / sum(frequency2)
    #     frequency2 = np.log10(frequency2)
    #     frequency2 = list(frequency2)

    #     # print(get_dist(frequency1, frequency2))

    #     t2 = time.time()

    #     end = int(round(t2 * 1000))
    #     print(len(G1.nodes), end-start,file=f)
