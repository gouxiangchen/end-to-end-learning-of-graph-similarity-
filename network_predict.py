...
mynet = graphConvNet()
mynet.load_state_dict(torch.load('/home/lmx/chen/graphlets/model/huge_dataset_ruin2_9epoch.para'))
# all_wrong = 0.
# all_count = 0
# filenames_x = get_file_name('E:\\图卷积\\混合大小图\\')
# filenames_y = get_file_name('E:\\图卷积\\混合大小图\\')
# result_file = open('result_wrong_mixooo_128.txt', 'w')

# draw_file = open('draw_re.txt', 'w')
filenames = get_file_name('/home/lmx/chen/graphlets/all')
f = open('modeltime.txt','w')
for filename in filenames:
    ...
    filename_x = filename
    # filename_y = '/home/lmx/chen/graphlets/testset/0bison0.txt'
...
#             la1 = f1.split('.')[0]
#             la2 = f2.split('.')[0]
#             label1_name = 'E:\\图卷积\\混合大小图标签\\' + la1 + '_label.txt'
#             label2_name = 'E:\\图卷积\\混合大小图标签\\' + la2 + '_label.txt'
...
#             print(out.data, l, file=draw_file)
#             all_count += 1
#             all_wrong += abs(float(out.data) - l)/l
#             file1.close()
#             file2.close()

# average_wrong = all_wrong/all_count
# print(average_wrong)
# result_file.close()
# draw_file.close()
#
